...
export async function fetch(connection: Transfork.Connection, namespace: string): Promise<Root> {
	const sub = await connection.subscribe(new Transfork.Track(namespace, ".catalog", 0))
	try {
