...
However bufferbloat causes *all* packets to get queued, possibly for seconds, ruling out any hope of timely delivery.
...
Look forward to the upcoming **Replacing RTMP *but please not with SRT*** blog post!
