...
export class Decoder {
	...
	async receive(header: Data.Header, stream: ReadableStream) {
		if (header.track === 0n) {
	...
	async #catalog(header: Data.Header, stream: ReadableStream) {
		try {
	...
	async #segment(header: Data.Header, stream: ReadableStream) {
